...
//         mockRedis.get.mockResolvedValue(await bcrypt.hash('refresh', 10));
...
//         mockJwtService.verifyAsync.mockResolvedValue({ id: 1 });
//         mockRedis.get.mockResolvedValue(await bcrypt.hash('other', 10));
//
//         await expect(service.refresh(1, 'token')).rejects.toThrow();
//     });
//
...
//
//         const user = await service.getUser('valid_token');
//         expect(user.email).toBe('a@test.com');
//     });
//
//
//     it('should throw if getUser token invalid', async () => {
//         mockJwtService.verify.mockImplementation(() => {
//             throw new Error();
//         });
//
//         await expect(service.getUser('bad')).rejects.toThrow();
//     });
//
...
//
//         await expect(service.logout('bad')).rejects.toThrow();
//     });
//
...
//     });
//
//     it('should throw if user not found in refresh', async () => {
//         mockJwtService.verifyAsync.mockResolvedValue({ id: 1 });
//         mockRedis.get.mockResolvedValue(await bcrypt.hash('token', 10));
